...
class DiffViewer extends React.Component {
    constructor(props) {
        ...
        this.renderDiff = (maxLines) => {
            ...
            let skippedLines = [];
            const nodes = [];
            const limit = maxLines !== null && maxLines !== void 0 ? maxLines : lineInformation.length;
            for (let i = 0; i < limit && i < lineInformation.length; i++) {
                ...
                if (this.props.showDiffOnly) {
                    ...
                    if (line.left.type === compute_lines_1.DiffType.DEFAULT &&
                        ...
                        if (i === lineInformation.length - 1 && skippedLines.length > 1) {
                            nodes.push(this.renderSkippedLineIndicator(skippedLines.length, diffBlockStart, line.left.lineNumber, line.right.lineNumber));
                        }
                        continue;
                    }
                }
                ...
                if (currentPosition === extraLines && skippedLines.length > 0) {
                    ...
                    skippedLines = [];
                    nodes.push(React.createElement(React.Fragment, { key: i },
        ...
        this.render = () => {
            ...
            if (visibleNodes.length < (0, compute_lines_1.computeLineInformation)(oldValue, newValue, this.props.noise, this.props.disableWordDiff, this.props.compareMethod, this.props.linesOffset).lineInformation.length) {
                requestIdleCallback === null || requestIdleCallback === void 0 ? void 0 : requestIdleCallback(() => {
                    this.setState((prev) => ({
